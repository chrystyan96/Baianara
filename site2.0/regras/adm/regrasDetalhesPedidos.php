...
<div class="modal-body">
    ...
    <label>Telefone: <?php echo mascara_string("(##)#####-####", $opcoesPedidos['telefone']); ?></label><br />
    <label>Data do Pedido: <?php echo $opcoesPedidos['data']; ?></label><br />
    <label>Atualização do Pedido: <?php echo $opcoesPedidos['dataUpdate']; ?></label><br /><br />
